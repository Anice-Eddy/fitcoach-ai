...
export function IdentityStep({ defaultValues, onNext }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onNext)} className="space-y-6">
      ...
      <button
        type="submit"
        className="w-full py-3 rounded-xl bg-[#C8F135] text-zinc-900 font-bold hover:bg-[#d4f54d] transition-colors mt-4"
      >
        Continuer →
      </button>
    </form>
