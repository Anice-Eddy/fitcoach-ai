'use client'
// Plan badge displayed in the sidebar and settings.
...
const PLAN_CONFIG = {
  FREE:     { labelKey: 'common.free',  icon: null,      color: 'text-zinc-400 bg-zinc-800 border-zinc-700' },
  PRO:      { labelKey: 'common.pro',   icon: Sparkles,  color: 'text-[#C8F135] bg-[#C8F135]/10 border-[#C8F135]/20' },
  ELITE:    { labelKey: 'common.elite', icon: Zap,       color: 'text-purple-400 bg-purple-400/10 border-purple-400/20' },
  BUSINESS: { labelKey: 'plan.business', icon: Building2, color: 'text-blue-400 bg-blue-400/10 border-blue-400/20' },
}
  ...
  return (
    <div className={cn('space-y-2', className)}>
      <div className={cn('inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-semibold border', config.color)}>
        ...
        {t('plan.label')} {t(config.labelKey)}
      </div>
      {plan === 'FREE' && (
        <Link
          href="/pricing"
